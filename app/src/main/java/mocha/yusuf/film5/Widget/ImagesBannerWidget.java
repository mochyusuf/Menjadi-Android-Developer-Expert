package mocha.yusuf.film5.Widget;
...
public class ImagesBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "mocha.yusuf.film5.TOAST_ACTION";
    public static final String EXTRA_ITEM = "mocha.yusuf.film5.EXTRA_ITEM";
